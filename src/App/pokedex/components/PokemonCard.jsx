...
function PokemonCard({ url }) {
  ...
  return (
    <Link to={`/pokedex/${pokemon.name}`} className="block">
      <div
        className={`rounded-xl p-[3px] bg-gradient-to-b from-[#dcbe29] to-[#cd5531]`}
      >
        <div className="rounded-xl overflow-hidden shadow-md">
          ...
          <div className="bg-gray-200 p-4 text-center">
            ...
            <ul
              className="border-t-1 border-gray-200 mt-4 pt-4 grid 
        grid-cols-2 gap-4"
            >
